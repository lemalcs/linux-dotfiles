...
def primary_widgets():
    return [
        *workspaces(),
        ...
        widget.Memory(background=colors['color3'], foreground=colors['text'], padding=5),
        ...
        icon(fg="light", bg="color1", text=' '), # Icon: nf-mdi-calendar_clock

        widget.Clock(**base(fg='light', bg='color1'), format='%Y-%m-%d - %H:%M '),
